...
CLASS ZASHM_02_1 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

* Example 1: Local Types
* Ejemplo 1: tipos locales
**********************************************************************

* Comment/Uncomment the following lines to change the type of my_var
* Comente/descomenta las siguientes líneas para cambiar el tipo de my_var
