CLASS zcl_fill_zs4d401_flights_ashm DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_fill_zs4d401_flights_ashm IMPLEMENTATION.
...
FROM /dmo/flight WHERE carrier_id = main~carrier_id
AND connection_id = main~connection_id )
GROUP BY carrier_id,
connection_Id,
flight_date, price,
 currency_code,
...
INSERT zs4d401_fli_ashm FROM TABLE @insert_tab.
